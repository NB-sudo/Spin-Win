...
function create(){
    ...
    button.setScale(0.10);
    let button1 = this.add.image(50, 90, 'button', 1).setInteractive();
    button1.name = "Spin";
    button1.setScale(0.10)
    this.input.on('gameobjectup', spinwheel, this)
}
...
function spinwheel(){
    ...
    let music = this.sound.add('play', config)
    music.play();
